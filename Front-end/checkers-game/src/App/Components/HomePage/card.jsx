...
const Card = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-800">
      <div className="w-1/2 h-88 p-5 text-white bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg border border-gray-200 rounded-md flex flex-col cursor-pointer transform origin-bottom-right transition-all duration-600 ease-in-out hover:rotate-8 hover:border-transparent hover:bg-opacity-50">
