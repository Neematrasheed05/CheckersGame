...
const PlayButton = () => {
  ...
  return (
    <>
    <button className="relative w-44 h-16 outline-none transition duration-100 bg-transparent border-none text-[13px] font-bold text-[#000000] group" onClick={playSound}>
      P L A Y !
      <div
        id="clip"
